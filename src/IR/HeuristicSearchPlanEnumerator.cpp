...
template<typename State, typename Expand, typename Heuristic, typename Config, typename... Context>
using hanwen_layered_search_sorted_dynamic_3 = ai::hanwen_layeredSearch_sorted_dynamic<3>::type<State, Expand, Heuristic, Config, Context...>;
...
#define HEURISTIC_SEARCH(STATE, EXPAND, HEURISTIC, SEARCH) \
        ...
        HEURISTIC_SEARCH(SubproblemsArray, BottomUpComplete, zero, hanwen_layered_search_sorted_dynamic_2)
        HEURISTIC_SEARCH(SubproblemsArray, BottomUpComplete, zero, hanwen_layered_search_sorted_dynamic_3)
